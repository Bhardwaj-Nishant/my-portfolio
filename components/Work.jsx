  ...
  return (
    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20' >
      ...
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
        “A collection of projects that highlight my approach to building intuitive, efficient, 
        and scalable software. From front-end interfaces to back-end logic, each project reflects both creativity and technical skill.” 
      </motion.p>
    ...
    transition={{delay: 0.6, duration: 0.5}}
      target='_blank' href="https://github.com/Bhardwaj-Nishant" className='w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 
