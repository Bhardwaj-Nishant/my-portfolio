...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "f9260e9c-608f-4c90-a255-ec899fdba09d");
  ...
  return (
    ...
    id='contact' className='w-full px-[12%] py-10 scroll-mt-12 bg-footer-light'>
      <motion.h4 
      ...
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
        ...
        or anyone with an interesting project idea. Feel free to reach out to discuss work, ask questions, or just say hello!”
      </motion.p>
