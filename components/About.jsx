...
const About = ({isDarkMode}) => {
  return (
    <motion.div id='about' className='w-full px-[12%] py-10 scroll-mt-12'
    initial={{opacity: 0}}
    ...
    transition={{duration: 0.6}}
        ...
        initial={{opacity: 0}}
    whileInView={{opacity: 1}}
    transition={{duration: 0.8, duration: 0.6}}
        className='flex-1'>
        <p className='mb-10 max-w-2xl font-Ovo'>
          “I am a passionate and dedicated individual with a strong interest in technology and problem-solving.
           I enjoy learning new skills, adapting to challenges, and contributing innovative ideas. With a positive mindset, 
           I strive for personal growth and meaningful achievements.”
        </p>
